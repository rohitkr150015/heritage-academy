  ...
  class SchoolDiscovery extends HTMLElement {
    connectedCallback() {
      ...
      this.shadowRoot.innerHTML = `<style>
        ...
        :host([theme=oakridge]){--bg:#354337;--deep:#202d24;--accent:#efd2a0;--muted:#d1d7c6}
    ...
    syncMotion() {
      ...
      this.setAttributeState('still', forced);
      this.syncOrbit();
    }
